...
Usage:
  ...
  omx memory    CLI parity surface for OMX backend-aware memory tools
    ...
    try {
        switch (command) {
            ...
            case "state":
                ...
                break;
            case "memory":
                await mcpParityCommand("memory", args.slice(1));
                break;
            case "notepad":
...
function buildDetachedWindowsBootstrapScript(sessionName, commandText, delayMs = WINDOWS_DETACHED_BOOTSTRAP_DELAY_MS) {
